...
public class Editar_Clientes extends AppCompatActivity {
    ...
    public void Modificar(View v){
        if(txtrazonsocial.getText().toString().trim().isEmpty()){
            ...
            Snackbar.make(findViewById(R.id.linearLayout71), "Busque y seleccione del combo una ciudad.", Snackbar.LENGTH_SHORT)
            ...
            if(respuesta >0){
                ...
                Snackbar.make(findViewById(R.id.linearLayout71), "CLIENTE MODIFICADO EXITOSAMENTE", Snackbar.LENGTH_INDEFINITE)
                        .setAnimationMode(BaseTransientBottomBar.ANIMATION_MODE_SLIDE)
                        .setBackgroundTint(Color.parseColor("#FF6F00"))
