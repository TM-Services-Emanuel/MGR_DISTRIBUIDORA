...
public class ListarUM extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem){
        ...
        if(id==R.id.item_download){
            ...
            alertDialog.setMessage("¿Seguro que desea descargar la lista de las unidades de medida?");
    ...
    public void ObtnerIP() {
        try {
            ...
            if (cursor.moveToNext()) {
                ...
                Snackbar.make(findViewById(R.id.linearLayout39), "IP DEL SERVIDOR NO ENCONTRADO.", Snackbar.LENGTH_SHORT)
                        .setAnimationMode(BaseTransientBottomBar.ANIMATION_MODE_SLIDE)
                        .setBackgroundTint(Color.parseColor("#FF6F00"))
                        .setActionTextColor(Color.parseColor("#FFFFFF")).show();
            }
